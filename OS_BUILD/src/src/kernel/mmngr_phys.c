...
void
pmmngr_init(size_t memSize, physical_addr bitmap)
{
  ...
  memset(_mmngr_memory_map, 0xf,
      pmmngr_get_block_count() / PMMNGR_BLOCKS_PER_BYTE);
}

void
pmmngr_init_region(physical_addr base, size_t size)
{
...
void
pmmngr_deinit_region(physical_addr base, size_t size)
{
...
void*
pmmngr_alloc_blocks(size_t size)
{
...
void
pmmngr_free_blocks(void* p, size_t size)
{
