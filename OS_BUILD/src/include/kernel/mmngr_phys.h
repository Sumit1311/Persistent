...
extern void
pmmngr_init(size_t, physical_addr);

//! enables a physical memory region for use
extern void
pmmngr_init_region(physical_addr, size_t);

//! disables a physical memory region as in use (unuseable)
extern void
pmmngr_deinit_region(physical_addr base, size_t);
...
extern void
pmmngr_free_block(void*);

//! allocates blocks of memory
extern void*
pmmngr_alloc_blocks(size_t);

//! frees blocks of memory
extern void
pmmngr_free_blocks(void*, size_t);
...
extern uint32_t
pmmngr_get_block_size();

//! enable or disable paging
extern void
pmmngr_paging_enable(bool);
...
extern void
pmmngr_load_PDBR(physical_addr);
