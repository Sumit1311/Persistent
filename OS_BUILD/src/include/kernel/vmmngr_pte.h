...
extern void
pt_entry_add_attrib(pt_entry* e, uint32_t attrib);

//! clears a flag in the page table entry
extern void
pt_entry_del_attrib(pt_entry* e, uint32_t attrib);

//! sets a frame to page table entry
extern void
pt_entry_set_frame(pt_entry*, physical_addr);

//! test if page is present
extern bool
pt_entry_is_present(pt_entry e);

//! test if page is writable
extern bool
pt_entry_is_writable(pt_entry e);

//! get page table entry frame address
extern physical_addr
pt_entry_pfn(pt_entry e);
