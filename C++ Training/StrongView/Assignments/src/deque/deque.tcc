...
void Deque_Node::push_front(int& e)
{
    if(front == 0)
    {
        return;
...
void Deque_Node::push_back(int &e)
{
...
bool Deque_Node::has_space_right()
{
...
Deque::Deque():node_list(0)
{
     
}

Deque::Deque(int size):node_list(size)
{
